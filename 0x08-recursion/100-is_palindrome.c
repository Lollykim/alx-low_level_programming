 ...
 * Return: tru or false fo palindrome string
 */
...
/**
 * contador - count how many digit has the string
 * @s1: is an address of memory
 * @cont1: is the counter
 * Return: how many digit has the given string
 */
...
/**
 * fakefake - set true or false for palindrome string
 * @s: is the first address of memory of string
 * @ss: is the last address of memory of sting
 * @count: is the counter of string
